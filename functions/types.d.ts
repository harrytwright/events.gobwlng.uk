/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./functions/types.d.ts` (hash: 9b55155cc9211a440d4d4e43b03632d9)
// Runtime types generated with workerd@1.20251210.0 2025-01-05 
declare namespace Cloudflare {
	interface Env {
		LINKS: KVNamespace;
		CLICKS_SEEN: KVNamespace;
		SHARE_CLICKS: AnalyticsEngineDataset;
	}
}
